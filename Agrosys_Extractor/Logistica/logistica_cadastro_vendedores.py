...
PASTA_SAIDA = Path(r"\\192.168.1.139\Controladoria\BI_Granja\Exportacoes\Logistica\Cadastro de Vendedores")
...
def baixar_unidade(ag, driver, unidade):
    print("=" * 80)
    print(f"Cadastro de Vendedores - {unidade['descricao']}")
    print("=" * 80)
    ...
    arquivo_destino = (
        PASTA_SAIDA
        / f"cadastro_vendedores_{unidade['nome_arquivo']}.xlsx"
    )
