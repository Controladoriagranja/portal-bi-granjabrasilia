...
PASTA_SAIDA = Path(r"\\192.168.1.139\Controladoria\BI_Granja\Exportacoes\Logistica\Devolucoes")
...
def baixar_periodo(ag, driver, unidade, data_ini, data_fim):
    print("=" * 80)
    print(f"Devoluções - {unidade['descricao']}")
    ...
    html, processo = ag.executar_relatorio(
        ...
        filtros=filtros,
        nome_debug=f"devolucao_{unidade['nome_arquivo']}_{data_ini.strftime('%d-%m-%Y')}",
        modulo="23451",
    )
