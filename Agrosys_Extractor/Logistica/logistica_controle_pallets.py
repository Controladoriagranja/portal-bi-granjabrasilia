...
PASTA_SAIDA = Path(r"\\192.168.1.139\Controladoria\BI_Granja\Exportacoes\Logistica\Controle de pallets")
...
UNIDADES = [
    {"codigo": "10", "nome_arquivo": "AVE_NOVA", "descricao": "010 - AVE NOVA"},
    {"codigo": "111", "nome_arquivo": "REAL_ALIMENTOS", "descricao": "111 - REAL ALIMENTOS"},
    {"codigo": "180", "nome_arquivo": "CD_RIBEIRAO_DAS_NEVES", "descricao": "180 - CD RIBEIRÃO DAS NEVES"},
]
...
def baixar_unidade(ag, driver, unidade):
    print("=" * 80)
    print(f"Controle de Pallets - {unidade['descricao']}")
    ...
    filtros = {
        ...
        "vtra-descricao": "",
        "vemb-codigo": "",
        "vemb-descricao": "Todos",
        "vrot-codigo": "",
        "vrot-nome": "",
        "vtipo-quebra": "",
        "vtipo": "S",
        "vpardate1": DATA_INICIO,
        "vpardate2": DATA_FIM,
        "vvei-placam": "",
        "vplaca": "",
        "vlog": "",
    ...
    html, processo = ag.executar_relatorio(
        caminho="/webpro/weball/wci730d1",
        menu=30214,
        unidade=unidade["codigo"],
        filtros=filtros,
        nome_debug=f"controle_pallets_{unidade['nome_arquivo']}",
        modulo="17611",
    )
    ...
    arquivo_destino = (
        PASTA_SAIDA
        / f"controle_pallets_{unidade['nome_arquivo']}.xlsx"
    )
...
def main():
    ...
    try:
        ...
        for unidade in UNIDADES:
            baixar_unidade(ag, driver, unidade)

        print("=" * 80)
        print("CONTROLE DE PALLETS FINALIZADO")
        print("=" * 80)
