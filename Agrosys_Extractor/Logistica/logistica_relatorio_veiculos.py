...
PASTA_SAIDA = Path(r"\\192.168.1.139\Controladoria\BI_Granja\Exportacoes\Logistica\Relatorio de Veiculos")
...
def baixar_unidade(ag, driver, unidade):
    print("=" * 80)
    print(f"Relatório de Veículos - {unidade['descricao']}")
    print("=" * 80)
    ...
    html, processo = ag.executar_relatorio(
        caminho="/webpro/weball/wppa900d2",
        menu=30240,
        unidade=unidade["codigo"],
        filtros=filtros,
        nome_debug=f"relatorio_veiculos_{unidade['nome_arquivo']}",
        modulo="23451",
    )
    ...
    arquivo_destino = (
        PASTA_SAIDA
        / f"relatorio_veiculos_{unidade['nome_arquivo']}.xlsx"
    )
...
def main():
    ...
    try:
        ...
        print("=" * 80)
        print("RELATÓRIO DE VEÍCULOS FINALIZADO")
        print("=" * 80)
